...
public class ConferenceBookingDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public ConferenceBookingDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
