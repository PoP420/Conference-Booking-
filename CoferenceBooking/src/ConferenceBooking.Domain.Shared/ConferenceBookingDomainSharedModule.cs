...
public class ConferenceBookingDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ConferenceBookingGlobalFeatureConfigurator.Configure();
        ConferenceBookingModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ConferenceBookingDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<ConferenceBookingResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/ConferenceBooking");

            options.DefaultResourceType = typeof(ConferenceBookingResource);
        ...
        {
            options.MapCodeNamespace("ConferenceBooking", typeof(ConferenceBookingResource));
        });
    }
}
